...
# makeECblob()
# Pulls the essential simulation states
# for testing for Exceptional Circumstances
# during MP updates.
# Args: obj = simulation object output by ms3R
# Returns: ECblob object
# Author: LFR
makeECblob <- function(obj = blob)
{
