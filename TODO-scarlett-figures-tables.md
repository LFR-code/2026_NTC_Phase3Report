...
- [ ] **Yield curve figure** (slide 2) -- DDM yield curve
...
- [ ] **Historical SSB comparison figure** (slide 3) -- Time
...
- [ ] **HCR diagram** (slide 4) -- Two-panel plot: harvest
...
- [ ] **DDM simulation projections** (slide 6) -- Three-panel:
...
- [ ] **DDM retrospective assessment fits** (slide 7) -- OM
...
- [ ] **DDM effective harvest rate scatter** (slide 8) --
...
- [ ] **Remove the TODO comment** at `03-results.Rmd` line 116
